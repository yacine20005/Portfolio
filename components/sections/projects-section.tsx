        ...
        <section id="projects" className="container mx-auto py-20 relative">
            ...
            <div className="space-y-4 mb-12">
                <div className="flex items-center">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold">{projectsData.title}</h2>
                </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center gap-4">
                                    {project.links.map((link, linkIndex) => (
                                        ...
                                        >
                                            {link.name === 'View Code' ? <Code className="h-4 w-4 mr-1" /> : <Send className="h-4 w-4 mr-1" />} {link.name}
                                        </Link>
                                    ))}
                                </div>
                            </div>
