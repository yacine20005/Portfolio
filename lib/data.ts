...
export const featuredProjectsData: FeaturedProjectsData = {
    ...
    projects: [
        ...
        },
        {
            ...
            theme: {
                gradientFrom: 'rgba(199, 210, 254, 0.1)',
                gradientVia: 'rgba(167, 139, 250, 0.05)',
                gradientTo: 'rgba(167, 139, 250, 0.1)',
                textColor: 'rgb(129, 140, 248)',
                descriptionColor: 'rgb(199, 210, 254)',
                accentColor: 'rgba(129, 140, 248, 0.5)',
                border: 'rgba(129, 140, 248, 0.3)',
                iconFrom: 'rgba(99, 102, 241, 0.9)',
                iconTo: 'rgba(139, 92, 246, 0.9)',
                shadowColor: 'rgba(99, 102, 241, 0.4)',
                badgeGradient: 'linear-gradient(135deg, rgb(99, 102, 241), rgb(139, 92, 246))',
                tagBackground: 'rgba(129, 140, 248, 0.15)',
                tagColor: 'rgb(199, 210, 254)',
                tagBorder: 'rgba(129, 140, 248, 0.3)',
                buttonFrom: 'rgba(99, 102, 241, 0.9)',
                buttonTo: 'rgba(139, 92, 246, 0.9)',
            },
        },
    ],
};