...
const features = [
    ...
    },
    {
        ...
        title: "Game Sharing",
        description:
            "Share your purchased games with friends so they can play without buying",
        status: "live",
    },
    {
...
const architectureHighlights = [
    {
        ...
        description:
            "Custom database views that aggregate data from multiple tables, automatically calculating genre collections and average ratings for optimized performance",
        icon: <Database className="h-5 w-5" />,
    },
    {
        title: "Bidirectional Relationships",
        description:
            "Optimized friendship system with database constraints to prevent duplicate entries and ensure consistency across all user connections",
        icon: <Users className="h-5 w-5" />,
    },
    {
        title: "Multi-Layer Validation",
        description:
            "Comprehensive validation system spanning database constraints, server-side form validation, and business logic verification for age restrictions and sharing rules",
        icon: <Lock className="h-5 w-5" />,
    },
    {
        title: "Transaction Management",
        description:
            "Complete financial tracking system with wallet balance management, detailed purchase history, and secure fund reloading capabilities",
...
export default function NuagePage() {
    ...
    return (
        <div className="min-h-screen bg-background text-foreground overflow-hidden">
            <Header />
            <main id="main-content" role="main" ref={contentScope}>
                {/* Full-screen Hero */}
                <section
                            ...
                            <div className="flex flex-col items-center gap-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <h1
                                        ...
                                        ref={titleRef}
                                        className="font-bold tracking-tighter leading-[1.2] bg-gradient-to-r from-purple-400/90 via-indigo-500/90 to-blue-500/90 bg-[length:200%_100%] animate-[pulse_12s_linear_infinite] bg-clip-text text-transparent select-none text-[3.2rem] sm:text-[5rem] md:text-[6.5rem] lg:text-[8rem] will-change-transform"
                                ...
                                <h2 className="text-lg sm:text-2xl md:text-3xl text-muted-foreground font-medium max-w-3xl animate-[fadeUp_1s_ease-out_0.35s_backwards]">
                                    Like Steam, but better (obviously).
                                </h2>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                },
                                {
                                    ...
                                    description:
                                        "Add friends to your network. Share your purchased games so they can play without buying.",
                                },
                                {
                                    step: "05",
                                    title: "Review & Rate",
