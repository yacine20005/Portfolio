  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <main id="main-content" role="main">
        {/* Hero */}
        <section
          className="container mx-auto py-28 md:py-36 relative"
          ...
          <div className="flex flex-col items-center text-center gap-8">
            <div className="max-w-4xl space-y-6">
              <div className="flex items-center justify-center gap-3">
                <div
                  className="h-10 w-10 rounded-xl bg-gradient-to-br from-pink-500 to-fuchsia-500 shadow-lg shadow-pink-500/20 flex items-center justify-center"
                  aria-hidden="true"
                >
                ...
                <h1
                  ...
                  className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-pink-500 via-rose-500 to-fuchsia-500 bg-clip-text text-transparent"
                >
                  Spark Love
                </h1>
              </div>
        ...
        <section className="container mx-auto py-16 md:py-20 relative">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-pink-500/20 bg-gradient-to-br from-pink-500/5 via-transparent to-fuchsia-500/5 p-8 md:p-12">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-3xl border border-pink-500/20 bg-gradient-to-br from-pink-500/10 via-rose-500/5 to-fuchsia-500/10 p-8 md:p-12">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-3xl border border-pink-500/20 bg-gradient-to-br from-fuchsia-500/10 via-rose-500/5 to-pink-500/10 p-8 md:p-12">
        ...
        <section className="container mx-auto py-16 md:py-24 relative">
          <SectionBackground />
          <div className="bg-gradient-to-r from-pink-500/10 to-fuchsia-500/10 rounded-2xl border border-border p-8 md:p-12">
